...
public class data_inn {
	...
	public static String ur = "http://192.168.1.113";
     ...
     * @return
     */
    public static StringBuilder walletUnlock(){
    	String parm = "\"[\\\"default\\\",\\\"PW5JDSeMeHEWfjefffepMaqB13krDK6Tw5z7tNHL9jPTyjaGH5WbA\\\"]\"";
    	String[] cmds = {"curl",ur+":8900/v1/wallet/unlock","-d"," "+parm};
     ...
     * @return
     */
    public static StringBuilder getPublicKey(){
    	String[] cmds = {"curl",ur+":8900/v1/wallet/get_public_keys"};
        process = new ProcessBuilder(cmds);
        all();
    ...
    public static StringBuilder getInfo() {
    	String[] cmds = {"curl",ur+":8888/v1/chain/get_info"};
    	process = new ProcessBuilder(cmds);
        all();
     ...
     * @return
     */
    public static StringBuilder getBlockInfo() {
    	String pram = "\"{\\\"block_num_or_id\\\":\\\""+head_block_num+"\\\"}\"";
    	String[] cmds = {"curl",ur+":8888/v1/chain/get_block","-d",pram};
    	process = new ProcessBuilder(cmds);
        all();
     ...
     * @return
     */
    public static StringBuilder getInternetData() {
     ...
     * @return
     */
    public static StringBuilder abiJsonToBin(){
    	String parm = "\"{\\\"code\\\":\\\"trace\\\",\\\"action\\\":\\\"insert\\\",\\\"args\\\":{\\\"user\\\":\\\"trace\\\",\\\"userid\\\":\\\"444\\\",\\\"time_point\\\":\\\""+head_block_time+"\\\",\\\"data\\\":\\\""+firstData+"\\\",\\\"attach\\\":\\\"\\\"}}\"";
    	String[] cmds = {"curl","-s",ur+":8888/v1/chain/abi_json_to_bin","-X","POST","-d",parm};
    	process = new ProcessBuilder(cmds);
    	all();
     ...
     */
	  ...
	  * @return
	  */
	 public static StringBuilder signTransaction(){
	    ...
	    String parm = " \"[{\\\"ref_block_num\\\":\\\""+head_block_num+"\\\",\\\"ref_block_prefix\\\":\\\""+ref_block_prefix+"\\\",\\\"expiration\\\":\\\""+createdate+"\\\",\\\"actions\\\":[{\\\"account\\\":\\\"trace\\\",\\\"name\\\":\\\"insert\\\",\\\"authorization\\\":[{\\\"actor\\\":\\\"trace\\\",\\\"permission\\\":\\\"active\\\"}],\\\"data\\\":\\\""+binargs+"\\\"}],\\\"signatures\\\":[]},"+required_keys+",\\\""+chain_id+"\\\"]\"";
	    String[] cmds = {"curl",ur+":8900/v1/wallet/sign_transaction","-d",parm};
    	process = new ProcessBuilder(cmds);
    	all();
	 ...
	 * @throws ParseException 
	  */
	 public static StringBuilder pushTransaction() {
		SimpleDateFormat formatter=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS");
    	Date date = null;
		try {
			date = formatter.parse(head_block_time1);
        ...
        String createdate = formatter.format(time);
        createdate = createdate.replaceAll(" ", "T");
	    String parm = "\"{\\\"compression\\\":\\\"none\\\",\\\"transaction\\\":{\\\"expiration\\\":\\\""+createdate+"\\\",\\\"ref_block_num\\\":\\\""+head_block_num+"\\\",\\\"ref_block_prefix\\\":\\\""+ref_block_prefix+"\\\",\\\"context_free_actions\\\":[],\\\"actions\\\":[{\\\"account\\\":\\\"trace\\\",\\\"name\\\":\\\"insert\\\",\\\"authorization\\\":[{\\\"actor\\\":\\\"trace\\\",\\\"permission\\\":\\\"active\\\"}],\\\"data\\\":\\\""+binargs+"\\\"}],\\\"transaction_extensions\\\":[]},\\\"signatures\\\":"+signatures+"}\"";
	    String[] cmds = {"curl","-s",ur+":8888/v1/chain/push_transaction","-d",parm};
	    process = new ProcessBuilder(cmds);
    	all();

package com.imooc.mvcmodeo.service.impl;

import com.imooc.mvcmodeo.model.Chapter;
...
public class CourseServiceImpl implements CourseService {
    ...
    public Course getCoursebyId(Integer courseId) {
        ...
        course.setDescr("多线程是日常开发中的常用的知识，也是难用的知识。。。。");
    ...
    private void warpChapterList(Integer courseId,List<Chapter> chapterList){
        ...
        chapter.setDescr("java语言层面对线程的支持，如何创建，启动和停止线程。如何使用常用的线程方法");
        chapterList.add(chapter);
